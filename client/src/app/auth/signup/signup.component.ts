...
export class SignupComponent {
  ...
  constructor(
    ...
    this.signupForm = this.formBuilder.group({
			...
			password: [null, [Validators.pattern(RegExpValidator.lowerCase), Validators.pattern(RegExpValidator.upperCase), Validators.pattern(RegExpValidator.digit), Validators.minLength(8), Validators.maxLength(30), Validators.required]],
